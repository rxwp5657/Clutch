...
TEST(LookAtTest, CanMakeLookAt)
{
    ...
    ASSERT_FLOAT_EQ(transform.get(0,2), 0.68599439f);
    ASSERT_FLOAT_EQ(transform.get(0,3), -2.4009802f);
    
    ASSERT_FLOAT_EQ(transform.get(1,0), 0.77892411f);
    ASSERT_FLOAT_EQ(transform.get(1,1), 0.61494005f);
    ASSERT_FLOAT_EQ(transform.get(1,2), 0.12298802f);
    ASSERT_FLOAT_EQ(transform.get(1,3), -2.8697202f);

    ASSERT_FLOAT_EQ(transform.get(2,0), -0.35856858f);
    ASSERT_FLOAT_EQ(transform.get(2,1),  0.59761435f);
